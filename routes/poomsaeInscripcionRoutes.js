...
router.get('/log/delegacion/evento/poomsae/poomsae_Inscripcion/cedula/:id_evento_fk/:id_delegacion_fk/:cedula/:modalidad', async (req, res) => {
    try {

        const { id_evento_fk, id_delegacion_fk, cedula, modalidad } = req.params;
...
router.get('/log/delegacion/evento/poomsae/poomsaeInscripcion/buscarCedula/:id_evento_fk/:id_delegacion_fk/:cedula', async (req, res) => {
    try {
